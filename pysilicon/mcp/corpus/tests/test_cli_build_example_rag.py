...
def test_build_example_rag_skips_unsupported_corpus_extensions(monkeypatch):
    ...
    assert uploaded_names == [
        "_CATALOG.md",
        "examples__pysilicon_path__poly__pysilicon_path__poly.py",
        "docs__pysilicon_path__poly__pysilicon_path__index.md",
    ]
...
def test_encode_decode_upload_filename_round_trip():
    ...
    assert encoded == "examples__pysilicon_path__conv2d__pysilicon_path__conv2d.py"
