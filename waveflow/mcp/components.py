"""
Deterministic glossary of waveflow schema vocabulary.
...
_COMPONENTS: list[dict] = [
    ...
    # -----------------------------------------------------------------------
    {
        ...
        "kind": "base_class",
        "description": (
            "Root base class for all waveflow schemas.  Every DataList, "
...
def get_components() -> dict:
    ...
    return {
        "summary": (
            "Canonical waveflow schema vocabulary: core classes "
            "(DataSchema, DataList, DataArray, DataField, IntField, FloatField, "
            "EnumField, MemAddr, IntEnum) and common design patterns. "
            "Use the keywords to form search queries for waveflow_search_examples."
        ),
