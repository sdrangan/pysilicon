...
class HistTest(object):
    ...
    def gen_vitis_code(self) -> list[Path]:
        ...
        generated_paths.append(gen_array_utils(Uint32Field, WORD_BW_SUPPORTED, cfg=cfg, streamutils_dir=self.include_dir))
    ...
    def test_vitis(
        ...
        project_dir = self.example_dir / "waveflow_hist_proj"
            ...
            try:
                result = toolchain.run_vitis_hls(
                    ...
                    env={
                        ...
                        "WAVEFLOW_HIST_THROUGH": vitis_through,
