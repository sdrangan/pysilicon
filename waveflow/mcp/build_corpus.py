...
Assembles a packaged corpus under ``waveflow/mcp/corpus/`` for users who do
...
def _repo_root() -> Path:
    """Return the repository root (the directory that contains waveflow/)."""
    # This file lives at <repo>/waveflow/mcp/build_corpus.py
