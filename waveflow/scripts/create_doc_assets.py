"""
create_doc_assets.py - Incremental doc asset (figure) generator for waveflow.
...
# ---------------------------------------------------------------------------
# Repository root (waveflow/scripts/ lives two levels below the root)
# ---------------------------------------------------------------------------
...
def _build_registry() -> dict[str, DocSet]:
    ...
    timing_deps = [
        ...
        _REPO_ROOT / "waveflow" / "utils" / "timing.py",
    ]
    timing_outputs = [
