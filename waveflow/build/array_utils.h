#ifndef WAVEFLOW_CODEGEN_ARRAY_UTILS_H
#define WAVEFLOW_CODEGEN_ARRAY_UTILS_H
 ...
 * emitted by Waveflow schema generators: elements are packed into each word from bit 0
...
#endif  // WAVEFLOW_CODEGEN_ARRAY_UTILS_H