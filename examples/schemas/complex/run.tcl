# Vitis HLS C-simulation driver for one ComplexField conformance kernel.
# The generated kernel.cpp + in_a.txt / in_b.txt are written next to this script
# (each case runs in its own directory); csim writes out_bits.txt back here.
...
puts "WAVEFLOW_SUCCESS: complex conformance csim passed."
exit 0
